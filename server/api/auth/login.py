...
from server.schemas.user import EmailRequest, EmailOTPRequest, PhoneTokenRequest
from sqlalchemy.orm import Session
from server.db import get_db
from server.utils.user import get_user_by_email, get_user_by_phone
from server.utils.helper import extract_phone
from server.utils.otp import check_rate_limit, send_otp_to_email, verify_email_otp
from server.utils.token import create_token
from firebase_admin import auth
from server.models.user import REVERSE_ROLE_MAP
